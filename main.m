...
FFT_size = N_block; %frame
Overlap = round(FFT_size/4); %Overlap Factor
lambda = c/fc; %wavelength in metres
%% compute a Doppler window 
Win = hamming(N_block); 
%% Compute STFT
[S, t, speed, nframes] = myspectro(y,Win,Overlap,FFT_size, fs, lambda, cpi, maxSpeed);
